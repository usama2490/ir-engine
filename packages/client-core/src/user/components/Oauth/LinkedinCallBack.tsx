...
const LinkedinCallbackComponent = (props): JSX.Element => {
  ...
  return state.error && state.error !== '' ? (
    ...
    <Container className={styles.promptForConnection}>
      ...
      <div className={styles.message}>{t('user:oauth.askConnection', { service: 'LinkedIn', email: state.email })}</div>
      <div className="flex">
...
export const LinkedinCallback = LinkedinCallbackComponent as any
