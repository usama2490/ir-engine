...
const FacebookCallbackComponent = (props): JSX.Element => {
  ...
  return state.error && state.error !== '' ? (
    <Container className={styles.oauthError}>
      <div className={styles.title}>{t('user:oauth.authFailed', { service: 'Meta' })}</div>
    ...
    <Container className={styles.promptForConnection}>
      ...
      <div className={styles.message}>{t('user:oauth.askConnection', { service: 'Meta', email: state.email })}</div>
      <div className="flex">
